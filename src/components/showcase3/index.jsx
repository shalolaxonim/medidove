...
export default function Showcase3() {
  return (
    <div>
      <div className="flex flex-col lg:flex-row bg-red-300 bg-[url('../../../doctor.webp')] bg-no-repeat bg-cover bg-right p-[50px]">
        <div className="bg-white flex flex-col gap-[20px] p-[20px] lg:p-[100px] lg:w-[55%] items-center text-center lg:text-start lg:items-start py-[80px]">
